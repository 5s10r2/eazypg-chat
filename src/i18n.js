...
export const TRANSLATIONS = {
  en: {
    ...
    welcome_subtitle: "Tarini, your broker in Mumbai. Search, compare, and book — all in chat.",
    input_placeholder: "Message Tarini…",
    ...
    agent_broker: "TARINI", agent_booking: "BOOKING", agent_profile: "PROFILE",
    agent_room: "ROOMS", agent_default: "TARINI", agent_thinking: "THINKING…",
  ...
  hi: {
    ...
    welcome_subtitle: "मुंबई में Tarini, आपकी ब्रोकर। खोजें, तुलना करें और बुक करें — सब चैट में।",
    input_placeholder: "Tarini को मैसेज करें…",
    ...
    agent_broker: "TARINI", agent_booking: "बुकिंग", agent_profile: "प्रोफ़ाइल",
    agent_room: "कमरे", agent_default: "TARINI", agent_thinking: "सोच रहा है…",
  ...
  mr: {
    ...
    welcome_subtitle: "मुंबईत Tarini, तुमची ब्रोकर। शोधा, तुलना करा आणि बुक करा — सगळं चॅटमध्ये.",
    input_placeholder: "Tarini ला मेसेज करा…",
    ...
    agent_broker: "TARINI", agent_booking: "बुकिंग", agent_profile: "प्रोफाइल",
    agent_room: "रूम्स", agent_default: "TARINI", agent_thinking: "विचार करत आहे…",
